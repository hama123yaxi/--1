...
if (message.content.startsWith("https://discord.gg/")) {
  ...
  message.author.send(` دانرا تۆش ڕیکلامەکە بکە https://discord.gg/pZbHB9Kxhr`) // لینکی سێرڤەری خۆت لیرە دابنی بە هەتا هەتای بێت
...
client.login("OTE2MjQ2MzA1MDQ5ODIxMjE0.YanW3g.LcL0QlF76ZLH9PY_diKm0qBN9C0");//تۆکین لێرە دانێ
